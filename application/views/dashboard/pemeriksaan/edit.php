        ...
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate method="POST" action="<?= site_url('pemeriksaan/simpan') ?>">
                        ...
                        <div class="col-sm-9">
                            <select name="dokter_id" id="dokter_id" class="form-control" required>
                                <?php foreach ($dokter  as $obj) { ?>
                                    <option value="<?= $obj->nama ?>" <?php if ($pasien->dokter_id == $obj->nama) echo 'selected' ?>><?= $obj->nama; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            <select name="poli_id" id="poli_id" class="form-control" required>
                                <?php foreach ($poli  as $obj) { ?>
                                    <option value="<?= $obj->nama ?>" <?php if ($pasien->poli_id == $obj->nama) echo 'selected' ?>><?= $obj->nama; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-md-9">
                            <div class="form-check-inline my-1">
                                <div class="custom-control custom-radio">
                                    <input type="radio" value="Rawat Inap" <?php if ($pasien->hasil == 'Rawat Inap') echo 'checked' ?> id="customRadio4" name="hasil" class="custom-control-input" required>
                                    <label class="custom-control-label" for="customRadio4">Rawat Inap</label>
                                </div>
                            </div>
                            <div class="form-check-inline my-1">
                                <div class="custom-control custom-radio">
                                    <input type="radio" value="Rawat Jalan" <?php if ($pasien->hasil == 'Rawat Jalan') echo 'checked' ?> id="customRadio5" name="hasil" class="custom-control-input" required>
                    ...
                    <a class="btn btn-secondary float-right mt-4" href="<?= site_url('pemeriksaan') ?>"><i class="fa fa-arrow-left"></i> Cancel</a>
                </form>
            </div>
        </div>
    </div> <!-- end col -->
